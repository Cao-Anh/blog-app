    ...
    <div>
        ...
        <div class="main-content">
            ...
            <div class="post-list">
                <!-- user info -->
                <div class="user-info">
                    <div class="profile-picture-bio">

                        <img :src="`/storage/${$page.props.user.profile_picture}`" alt="Profile Picture"
                            class="profile-picture" />
                    </div>
                    <div class="user-details">
                        <h2 class="user-name">Krystel Waters</h2>
                        <p class="username">@krystelw</p>
                        <p class="bio">Lover of art, music, and everything creative. Living life one post at a time.</p>
                    </div>
                </div>
                <h1>Posts</h1>
